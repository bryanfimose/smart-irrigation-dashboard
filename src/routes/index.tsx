...
import { DashboardHome } from '@/routes/app/index'
...
export const Route = createFileRoute('/')({
  head: () => ({
    meta: [
      ...
      { name: 'description', content: 'Monitore sua irrigação em tempo real e controle a bomba conectada ao ESP32 via MQTT.' },
    ],
  }),
